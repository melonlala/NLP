...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--dataroot', default='/home/zgjgroup/psy/nlp/data', help='root of data')
    arg_parser.add_argument('--word2vec_path', default='/home/zgjgroup/psy/nlp/word2vec-768.txt', help='path of word2vector file path')
